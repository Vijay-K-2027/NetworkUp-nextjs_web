...
export default function SetsApart() {
    return (
        <section id="use-cases" className="w-full bg-[#fafcf7] py-28 px-6 lg:px-8 overflow-hidden bg-[radial-gradient(circle_at_bottom_left,_rgba(222,250,208,1)_0%,_rgba(222,250,208,0.2)_500px,_rgba(222,250,208,0%)_70%)]">
