        ...
        <section className="w-full bg-[#fafcf7] py-20 px-6 lg:px-8">
            <div className="mx-auto max-w-7xl -mt-25">
                ...
                <div className="flex flex-col items-center text-center mb-20">
                    ...
                    <p className="text-[#253a00] text-sm sm:text-base w-[300px] sm:w-[550px] leading-relaxed">
                    ...
                    <div className="flex flex-row items-center mt-5 gap-3">
                        <span className="text-black font-bold text-sm sm:text-base leading-relaxed">Monthly</span>
                        <span>
