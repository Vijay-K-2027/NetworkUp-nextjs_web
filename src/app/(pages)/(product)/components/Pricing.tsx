                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-7xl mx-auto">
                    {plans.map((plan, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -8 }}
                            className={`relative h-fit flex flex-col justify-between p-8 sm:p-10 rounded-[2.25rem] bg-[#fafff6] transition-all duration-300 ${plan.popular ? "border-2 border-[#6ba00f] shadow-[0_0_50px_10px_rgba(118,225,27,0.2)]" : "border-2 border-[#b4b4b4]/70 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.01)] "
                                }`}
                        >
                            {/* Popular Badge */}
                            {plan.popular && (
