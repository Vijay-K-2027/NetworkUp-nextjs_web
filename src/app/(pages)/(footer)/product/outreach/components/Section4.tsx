...
const features = [
    {
        title: "Basic Info (Automation Setup):",
        content: "Name your workflow and define when it should run."
    },
    {
        title: "Target Words (Conversation Triggers):",
        content: "Choose the keywords and messages that should activate your workflow."
    },
    {
        title: "Reply Flow (Response Strategy):",
        content: "Create personalized replies based on the conversation context."
    },
    {
        title: "Sender Profile (LinkedIn Account):",
        content: "Select the account and profile that will handle your conversations."
    },
    {
        title: "Final Review (Launch & Monitor):",
        content: "Review your setup, test the workflow, and activate automation."
    }
];
