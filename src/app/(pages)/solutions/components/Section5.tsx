...
export default function Section5() {
            ...
            <div className="flex flex-row items-center justify-between w-full pb-4 border-b border-gray-100">
                ...
                <div className="flex flex-row items-center gap-x-4">
                    <div className="flex items-center gap-x-1.5">
                        ...
                        <span className="text-xs font-semibold text-[#111827]">Connections</span>
                    </div>
                    <div className="flex items-center gap-x-1.5">
                        <span className="w-2.5 h-2.5 rounded-full bg-[#bbf72a]"></span>
                        <span className="text-xs font-semibold text-[#111827]">Replies</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-row items-end justify-between gap-x-3 sm:gap-x-5 h-48 px-2">
                ...
                <div className="flex flex-col items-center gap-y-3 flex-1">
                    <motion.div
                        ...
                        style={{ height: '60px' }}
                    />
                    <span className="text-[10px] sm:text-xs font-semibold text-[#9ca3af] text-center">Apr 28</span>
                </div>
                {/* Col 2 */}
                <div className="flex flex-col items-center gap-y-3 flex-1">
                    <motion.div
                ...
                <div className="flex flex-col items-center gap-y-3 flex-1">
                    <motion.div
                        ...
                        className="w-full max-w-[80px] bg-[#7ceb2a] rounded-t-lg origin-bottom shadow-lg shadow-[#71EB34]/20"
                        style={{ height: '130px' }}
                    />
                    <span className="text-[10px] sm:text-xs font-bold text-[#9ca3af] text-center">May 12</span>
                </div>
                {/* Col 4 */}
                <div className="flex flex-col items-center gap-y-3 flex-1">
                    <motion.div
                        ...
                        style={{ height: '80px' }}
                    />
                    <span className="text-[10px] sm:text-xs font-semibold text-[#9ca3af] text-center">May 19</span>
                </div>
                {/* Col 5 */}
                <div className="flex flex-col items-center gap-y-3 flex-1">
                    <motion.div
                        ...
                        style={{ height: '108px' }}
                    />
                    <span className="text-[10px] sm:text-xs font-semibold text-[#9ca3af] text-center">May 26</span>
                </div>
            </div>
        </motion.div>
    )
    ...
    return (
        <SplitFeatureSection
            ...
            containerClass="w-full max-w-7xl bg-[#f9fafb] rounded-b-xl mx-auto -mt-10 py-10 lg:py-20 px-6 sm:px-10 border border-gray-100 "
        />
    )
}